...
class ScanSceneHook(Hook):
    ...
    def execute(self, **kwargs):
        ...
        cleanup.assetCheckAndTag(type = 'LND', customTag = 'staticLND')
        ...
        ## Now cleanup
        cleanup.cleanUp(items = items, checkShapes = True, history = True, pivots = False, freezeXFRM = False, smoothLvl = False, tagSmoothed = True, checkVerts = False, 
