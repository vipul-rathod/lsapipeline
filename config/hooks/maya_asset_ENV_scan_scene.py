...
class ScanSceneHook(Hook):
    ...
    def execute(self, **kwargs):
        ...
        ##cleanup.assetCheckAndTag(type = 'ENV', customTag = 'staticENV')
...
#             raise TankError("Incorrect Suffixes found! Fix suffixes before publishing.\nCheck the outliner for the incorrect_Geo_Suffix set.")
        ...
        ## UNCOMMENT FOR MDL STEP
        ## PEFORM MDL CLEANUP
        cleanup.cleanUp(items = items, checkShapes = False, history = False, pivots = False, freezeXFRM = False, smoothLvl = False, tagSmoothed = False, checkVerts = False, 
