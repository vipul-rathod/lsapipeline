...
class SceneBrowserWidget(browser_widget.BrowserWidget):
    ...
    def get_data(self, data):
        ...
        items = []
        read_nodes = self._app.execute_hook("hook_scan_scene")
        ...
        for read_node in read_nodes:
            ...
            node_name = read_node.get("node")
            node_type = read_node.get("type")
            file_name = read_node.get("path").replace("/", os.path.sep)
